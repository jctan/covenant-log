        ...
        <div class="admin-modal__body admin-editor-image-insert__body">
            ...
            {:else}
              ...
              >
                ...
                <span class="admin-editor-image-insert__source-copy">
                  ...
                  <span>{selectedFile ? formatBytes(selectedFile.size) : 'Saved to the current content\u2019s attachment directory after uploading, then inserted as Markdown'}</span>
                </span>
              </button>
            {/if}
          ...
          {:else}
            <label class="admin-field admin-editor-image-insert__field">
              <span class="admin-field__label">Image link</span>
              <input
