...
let {
  ...
  outlineHeadingsTabLabel = 'Outline',
  outlineHeadingsTabIcon = undefined,
  outlineListTabLabel = 'Post List',
  outlineHeadingsEmptyText = 'No H2/H3 headings yet',
  outlineListEmptyText = 'No posts yet',
...
<div
  ...
  aria-label="Editor auxiliary panels"
>
  {#if outlineVisible}
  ...
  {#if layout === 'stacked'}
    ...
    <div
      ...
      role="separator"
      tabindex="0"
      aria-label="Resize outline and syntax panel height"
