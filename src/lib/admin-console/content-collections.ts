...
export const ADMIN_CONTENT_COLLECTION_CAPABILITIES = {
  ...
  memo: {
    ...
    imagePicker: false,
    readonlyReason: null,
    deleteUnsupportedReason: "memo is a fixed single-page content type and can't be deleted from Content Console"
  },
  about: {
    collection: 'about',
    label: 'About',
    ...
    imagePicker: false,
    readonlyReason: null,
    deleteUnsupportedReason: "about is a fixed single-page content type and can't be deleted from Content Console"
  }
