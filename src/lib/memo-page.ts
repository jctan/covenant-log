export const LEGACY_MEMO_INTRO_LINES = [
  ...
  "Some moments carry a particular scent or glow, lingering briefly before they fade.",
  "Some feelings can't be captured by a lens; some memories resist being kept as images.",
  "Maybe keeping a written backup of a fleeting feeling is the gentlest, yet most effective, way to resist forgetting."
] as const;
